<script lang="ts">
    ...
    let translation: ProjectTranslation = $derived(
        translations[locale].project,
    );
    ...
    let steps = $derived({
        blog: {
            ...
            descriptionHighlightPart1:
                translation.blog.description_highlight_part_1,
            descriptionPart2: translation.blog.description_part_2,
            descriptionHighlightPart2:
                translation.blog.description_highlight_part_2,
            descriptionPart3: translation.blog.description_part_3,
            descriptionHighlightPart3:
                translation.blog.description_highlight_part_3,
            descriptionPart4: translation.blog.description_part_4,
            descriptionHighlightPart4:
                translation.blog.description_highlight_part_4,
            descriptionPart5: translation.blog.description_part_5,
            descriptionHighlightPart5:
                translation.blog.description_highlight_part_5,
        },
        note: {
            ...
            descriptionHighlightPart1:
                translation.note.description_highlight_part_1,
            descriptionPart2: translation.note.description_part_2,
            descriptionHighlightPart2:
                translation.note.description_highlight_part_2,
            descriptionPart3: translation.note.description_part_3,
            descriptionHighlightPart3:
                translation.note.description_highlight_part_3,
            descriptionPart4: translation.note.description_part_4,
            descriptionHighlightPart4:
                translation.note.description_highlight_part_4,
            descriptionPart5: translation.note.description_part_5,
            descriptionHighlightPart5:
                translation.note.description_highlight_part_5,
        },
        slide: {
            ...
            descriptionHighlightPart1:
                translation.slide.description_highlight_part_1,
            descriptionPart2: translation.slide.description_part_2,
            descriptionHighlightPart2:
                translation.slide.description_highlight_part_2,
            descriptionPart3: translation.slide.description_part_3,
            descriptionHighlightPart3:
                translation.slide.description_highlight_part_3,
            descriptionPart4: translation.slide.description_part_4,
            descriptionHighlightPart4:
                translation.slide.description_highlight_part_4,
            descriptionPart5: translation.slide.description_part_5,
            descriptionHighlightPart5:
                translation.slide.description_highlight_part_5,
        },
    });
</script>
...
<section id="project" class="flex flex-col gap-24 py-20">
    ...
    <div
        class="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-10 dark:text-neutral-50"
    >
