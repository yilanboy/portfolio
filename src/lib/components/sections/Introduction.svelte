<script lang="ts">
    ...
    let translation: IntroductionTranslation = $derived(
...
>
    ...
    >
        ...
        <p
            class="inline-block text-base sm:text-lg md:text-xl dark:text-neutral-50"
        >
        ...
        >
            I Love
            <span
                class="relative inline-block h-full text-indigo-500 before:absolute before:-right-8 before:-bottom-2 before:h-1.5 before:w-8 before:animate-blink before:bg-indigo-500 before:contain-none"
                >{dynamicText}</span
            >
        </p>
    </div>
